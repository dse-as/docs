...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="xsl:initial-template">
    ...
    <xsl:result-document href="hackmd-backup/.commit-message.txt" method="text" encoding="UTF-8">
      ...
      <xsl:text>generated by pup (https://github.com/ericchiang/pup) and {system-property('xsl:product-name'), system-property('xsl:product-version')} using XSLT {system-property('xsl:version')} / XPath {system-property('xsl:xpath-version')}</xsl:text>
    </xsl:result-document>
